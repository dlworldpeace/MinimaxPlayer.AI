...
def testperf(agent_name1, agent1, agent_name2, agent2):		
	...
	# Register players
	config.register_player(name=agent_name1, algorithm=Ivegner())
	config.register_player(name=agent_name2, algorithm=Ivegner())
...
def parse_arguments():
    ...
    parser.add_argument('-a1', '--agent1', help="Agent 1", default=Ivegner())    
    parser.add_argument('-n2', '--agent_name2', help="Name of agent 2", default="Your agent", type=str)
    parser.add_argument('-a2', '--agent2', help="Agent 2", default=Ivegner())    
